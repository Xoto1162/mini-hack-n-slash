...
*/
    ...
    ***************************************************************************/
    ...
    public void mouseClicked(MouseEvent e) {
        ...
        int x = (int) (mouseX() * GameWorld.getCamera().getTailleGrille());
        int y = (int) (mouseY() * GameWorld.getCamera().getTailleGrille());
        Position pos = GameWorld.getCamera().mousePosToGamePos(new Position(x, y));
        if (pos != null) {
            switch (e.getButton()) {
                case 1:
                    GameWorld.getPlayer().lancerMissile();
                    break;
                case 3:
                    GameWorld.getPlayer().lancerBombe(pos);
                    break;
            }
        }
    }
